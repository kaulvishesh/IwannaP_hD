...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function us(e,t,n){let r=new Float32Array(Xo),i=new G(0,1,0);return new ka({name:`SphericalGaussianBlur`,defines:{n:Xo,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:ps(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function ds(){return new ka({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:ps(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function fs(){return new ka({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:ps(),fragmentShader:`
	...
	`}var ms=class extends pn{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new la(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`)+`
`+_);let y=v+g+o,b=v+_+s,x=jc(i,i.VERTEX_SHADER,y),S=jc(i,i.FRAGMENT_SHADER,b);i.attachShader(h,x),i.attachShader(h,S),n.index0AttributeName===void 0?n.morphTargets===!0&&i.bindAttribLocation(h,0,`position`):i.bindAttribLocation(h,0,n.index0AttributeName),i.linkProgram(h);function C(t){if(e.debug.checkShaderErrors){let n=i.getProgramInfoLog(h)||``,r=i.getShaderInfoLog(x)||``,a=i.getShaderInfoLog(S)||``,o=n.trim(),s=r.trim(),c=a.trim(),l=!0,u=!0;if(i.getProgramParameter(h,i.LINK_STATUS)===!1)if(l=!1,typeof e.debug.onShaderError==`function`)e.debug.onShaderError(i,h,x,S);else{let e=Lc(i,x,`vertex`),n=Lc(i,S,`fragment`);H(`THREE.WebGLProgram: Shader Error `+i.getError()+` - VALIDATE_STATUS `+i.getProgramParameter(h,i.VALIDATE_STATUS)+`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
      ...
      `}),(0,$.jsxs)(`section`,{className:`stats-hud`,children:[(0,$.jsxs)(`div`,{className:`stat-card-v2`,onPointerOver:r,children:[(0,$.jsx)(`span`,{className:`stat-title-v2`,children:`Supervisors Matched`}),(0,$.jsxs)(`span`,{className:`stat-value-v2`,children:[`#`,x.count]}),(0,$.jsx)(`span`,{className:`stat-footer-v2`,children:`Total candidate links`})]}),(0,$.jsxs)(`div`,{className:`stat-card-v2`,onPointerOver:r,children:[(0,$.jsx)(`span`,{className:`stat-title-v2`,children:`Peak Match Score`}),(0,$.jsx)(`span`,{className:`stat-value-v2`,style:{color:x.peakScore>=80?`#10B981`:`#F59E0B`},children:x.peakScore>0?`${x.peakScore}%`:`—`}),(0,$.jsx)(`span`,{className:`stat-footer-v2`,children:`Highest compatibility`})]}),(0,$.jsxs)(`div`,{className:`stat-card-v2`,onPointerOver:r,children:[(0,$.jsx)(`span`,{className:`stat-title-v2`,children:`Average H-Index`}),(0,$.jsx)(`span`,{className:`stat-value-v2`,children:x.avgHIndex}),(0,$.jsx)(`span`,{className:`stat-footer-v2`,children:`Citation frequency rating`})]}),(0,$.jsxs)(`div`,{className:`stat-card-v2`,onPointerOver:r,children:[(0,$.jsx)(`span`,{className:`stat-title-v2`,children:`Total Citation Pool`}),(0,$.jsx)(`span`,{className:`stat-value-v2`,children:x.totalCitations>0?x.totalCitations.toLocaleString():`—`}),(0,$.jsx)(`span`,{className:`stat-footer-v2`,children:`Matched scholar footprint`})]}),(0,$.jsxs)(`div`,{className:`stat-card-v2`,onPointerOver:r,children:[(0,$.jsx)(`span`,{className:`stat-title-v2`,children:`Institutions`}),(0,$.jsx)(`span`,{className:`stat-value-v2`,children:x.uniqueUnis}),(0,$.jsx)(`span`,{className:`stat-footer-v2`,children:`Unique universities represented`})]})]}),(0,$.jsx)(`section`,{className:`filter-hud-card`,children:(0,$.jsxs)(`div`,{className:`filter-grid-v2`,children:[(0,$.jsxs)(`div`,{className:`form-group`,style:{margin:0},children:[(0,$.jsx)(`span`,{className:`form-label`,style:{fontSize:`0.7rem`},children:`Search Matches`}),(0,$.jsxs)(`div`,{style:{position:`relative`},children:[(0,$.jsx)(`input`,{type:`text`,className:`input-text`,placeholder:`Search name, university, keyword...`,value:c,onChange:e=>l(e.target.value),style:{paddingRight:`30px`}}),c&&(0,$.jsx)(`button`,{onClick:()=>l(``),style:{position:`absolute`,right:`10px`,top:`50%`,transform:`translateY(-50%)`,border:`none`,background:`none`,cursor:`pointer`,color:`var(--gl-gray)`,fontSize:`0.9rem`},children:`×`})]})]}),(0,$.jsxs)(`div`,{className:`form-group`,style:{margin:0},children:[(0,$.jsxs)(`span`,{className:`form-label`,style:{fontSize:`0.7rem`,display:`flex`,justifyContent:`space-between`},children:[(0,$.jsx)(`span`,{children:`Min Match Score`}),(0,$.jsxs)(`strong`,{style:{fontFamily:`var(--font-mono)`},children:[u,`%`]})]}),(0,$.jsx)(`input`,{type:`range`,min:`0`,max:`100`,value:u,onChange:e=>d(parseInt(e.target.value)),style:{width:`100%`,height:`6px`,background:`var(--gl-border)`,outline:`none`,accentColor:`var(--gl-black)`,cursor:`pointer`}})]}),(0,$.jsxs)(`div`,{className:`form-group`,style:{margin:0},children:[(0,$.jsx)(`span`,{className:`form-label`,style:{fontSize:`0.7rem`},children:`Filter by Institution`}),(0,$.jsx)(`select`,{value:f,onChange:e=>p(e.target.value),style:{width:`100%`,padding:`10px 12px`,borderRadius:`8px`,border:`1px solid var(--gl-border)`,backgroundColor:`var(--gl-light)`,color:`var(--gl-black)`,fontSize:`0.82rem`,fontFamily:`var(--font-sans)`,fontWeight:600,outline:`none`,cursor:`pointer`},children:S.map((e,t)=>(0,$.jsx)(`option`,{value:e,children:e===`ALL`?`🏫 All Universities`:e},t))})]}),(0,$.jsxs)(`div`,{className:`form-group`,style:{margin:0},children:[(0,$.jsx)(`span`,{className:`form-label`,style:{fontSize:`0.7rem`},children:`Sort Directory`}),(0,$.jsxs)(`div`,{style:{display:`flex`,gap:`8px`},children:[(0,$.jsxs)(`select`,{value:m,onChange:e=>h(e.target.value),style:{flex:1,padding:`10px 12px`,borderRadius:`8px`,border:`1px solid var(--gl-border)`,backgroundColor:`var(--gl-light)`,color:`var(--gl-black)`,fontSize:`0.82rem`,fontFamily:`var(--font-sans)`,fontWeight:600,outline:`none`,cursor:`pointer`},children:[(0,$.jsx)(`option`,{value:`score-desc`,children:`🏆 Compatibility Score (High → Low)`}),(0,$.jsx)(`option`,{value:`score-asc`,children:` Compatibility Score (Low → High)`}),(0,$.jsx)(`option`,{value:`citations-desc`,children:`📚 Citation Impact (High → Low)`}),(0,$.jsx)(`option`,{value:`hindex-desc`,children:`📈 Scholar H-Index (High → Low)`}),(0,$.jsx)(`option`,{value:`name-asc`,children:`🔤 Alphabetical (A → Z)`})]}),(c||u>0||f!==`ALL`||m!==`score-desc`)&&(0,$.jsx)(`button`,{className:`btn btn-secondary`,onClick:T,style:{width:`auto`,padding:`10px 14px`,fontSize:`0.8rem`},title:`Reset Filters`,children:`⟲`})]})]})]})}),(0,$.jsxs)(`section`,{className:`workspace-tabs-container`,children:[(0,$.jsxs)(`div`,{style:{display:`flex`,gap:`16px`},children:[(0,$.jsxs)(`button`,{className:`tab-btn-v2 ${a===`directory`?`active`:``}`,onClick:()=>{n(),o(`directory`)},children:[`📁 Supervisor matches (`,C.length,`)`]}),(0,$.jsx)(`button`,{className:`tab-btn-v2 ${a===`memory`?`active`:``}`,onClick:()=>{n(),o(`memory`)},children:`🧠 Subspace Memory Graph`})]}),a===`directory`&&C.length>0&&(0,$.jsxs)(`div`,{className:`layout-toggle-container`,children:[(0,$.jsx)(`button`,{className:`layout-toggle-btn ${g===`grid`?`active`:``}`,onClick:()=>{n(),v(`grid`)},children:`⊞ Grid`}),(0,$.jsx)(`button`,{className:`layout-toggle-btn ${g===`list`?`active`:``}`,onClick:()=>{n(),v(`list`)},children:`☰ List`})]})]}),(0,$.jsx)(`div`,{className:`tab-context-panel`,style:{flex:1},children:a===`memory`?s:(0,$.jsx)($.Fragment,{children:C.length===0?(0,$.jsxs)(`div`,{className:`card`,style:{textAlign:`center`,padding:`60px 20px`,color:`var(--gl-gray)`,display:`flex`,flexDirection:`column`,justifyContent:`center`,alignItems:`center`,minHeight:`300px`},children:[(0,$.jsx)(`span`,{style:{fontSize:`2.5rem`,marginBottom:`16px`},children:`🔍`}),(0,$.jsx)(`h4`,{style:{color:`var(--gl-black)`,marginBottom:`8px`,fontSize:`1.1rem`},children:`No Matched Supervisors Found`}),(0,$.jsx)(`p`,{style:{fontSize:`0.85rem`,maxWidth:`400px`},children:e.length===0?`Awaiting academic resume or portfolio upload. Use the sidebar controls to begin the autonomous matching pipeline.`:`No matches satisfy your filter parameters. Try adjusting the search query, compatibility score slider, or reset your filters.`}),e.length>0&&(0,$.jsx)(`button`,{className:`btn`,style:{marginTop:`20px`,width:`auto`,padding:`10px 20px`},onClick:T,children:`Clear Filters`})]}):g===`grid`?(0,$.jsx)(`div`,{className:`results-grid`,children:C.map(e=>(0,$.jsx)(Cu,{prof:e,onOpenEmail:t,playHoverSound:r,playClickSound:n},e.id))}):(0,$.jsx)(`div`,{className:`list-view-container`,children:C.map(e=>{let i=!!y[e.id],a=e.match_analysis?.score||0,o=`#EF4444`;return a>=80?o=`#10B981`:a>=60?o=`#6366F1`:a>=40&&(o=`#F59E0B`),(0,$.jsxs)(`div`,{className:`list-row-item`,children:[(0,$.jsxs)(`div`,{className:`list-row-header`,onClick:()=>w(e.id),children:[(0,$.jsxs)(`div`,{className:`list-row-main-info`,children:[(0,$.jsxs)(`div`,{className:`list-row-score-badge`,style:{backgroundColor:`${o}10`,color:o,border:`1.5px solid ${o}40`},children:[a,`%`]}),(0,$.jsxs)(`div`,{className:`list-row-meta`,children:[(0,$.jsx)(`span`,{className:`list-row-name`,children:e.name}),(0,$.jsxs)(`span`,{className:`list-row-subtext`,children:[e.university,` • `,(0,$.jsx)(`span`,{style:{fontStyle:`italic`},children:e.department_or_lab||`Department`})]})]})]}),(0,$.jsxs)(`div`,{className:`list-row-actions`,children:[(0,$.jsxs)(`div`,{className:`list-row-stats-group`,children:[(0,$.jsxs)(`div`,{className:`list-row-stat`,children:[(0,$.jsx)(`span`,{className:`list-row-stat-val`,children:e.citations||`—`}),(0,$.jsx)(`span`,{className:`list-row-stat-lbl`,children:`Citations`})]}),(0,$.jsxs)(`div`,{className:`list-row-stat`,children:[(0,$.jsx)(`span`,{className:`list-row-stat-val`,children:e.h_index||`—`}),(0,$.jsx)(`span`,{className:`list-row-stat-lbl`,children:`H-Index`})]}),(0,$.jsxs)(`div`,{className:`list-row-stat`,children:[(0,$.jsx)(`span`,{className:`list-row-stat-val`,children:e.recent_papers?.length||0}),(0,$.jsx)(`span`,{className:`list-row-stat-lbl`,children:`Papers`})]})]}),(0,$.jsx)(`div`,{className:`list-row-chevron`,style:{transform:i?`rotate(180deg)`:`rotate(0deg)`},children:`▼`})]})]}),i&&(0,$.jsx)(`div`,{className:`list-row-body-drawer`,children:(0,$.jsx)(`div`,{className:`list-row-body-inner`,children:(0,$.jsx)(Cu,{prof:e,onOpenEmail:t,playHoverSound:r,playClickSound:n,isFlatCard:!0})})})]},e.id)})})})})]})}var Tu=null,Eu=(e,t,n,r=`sine`,i=null)=>{try{Tu||=new(window.AudioContext||window.webkitAudioContext),Tu.state===`suspended`&&Tu.resume();let a=Tu.createOscillator(),o=Tu.createGain();a.connect(o),o.connect(Tu.destination),a.type=r,a.frequency.setValueAtTime(e,Tu.currentTime),i&&a.frequency.exponentialRampToValueAtTime(i,Tu.currentTime+t*.35),o.gain.setValueAtTime(n,Tu.currentTime),o.gain.exponentialRampToValueAtTime(1e-4,Tu.currentTime+t),a.start(),a.stop(Tu.currentTime+t)}catch(e){console.warn(`Audio playback blocked or failed:`,e)}},Du=()=>Eu(1200,.012,.008,`triangle`,700),Ou=()=>{Eu(800,.03,.025,`triangle`,150),setTimeout(()=>Eu(1600,.015,.012,`sine`),10)},ku=()=>{Eu(523.25,.12,.02,`sine`,1046.5),setTimeout(()=>Eu(659.25,.12,.02,`sine`,1318.5),50),setTimeout(()=>Eu(783.99,.22,.02,`sine`,1568),100)};function Au(e,t,n=750,r=480){if(!e||Object.keys(e).length===0)return[];let i=Object.keys(e),a=i.map((t,a)=>{let o=a/i.length*Math.PI*2,s=Math.min(n,r)*.35;return{id:t,label:e[t].label,properties:e[t].properties,x:n/2+Math.cos(o)*s+(Math.random()-.5)*10,y:r/2+Math.sin(o)*s+(Math.random()-.5)*10}}),o={};a.forEach(e=>{o[e.id]=e});let s=Math.sqrt(n*r/(a.length||1))*.8;for(let e=0;e<100;e++){for(let e=0;e<a.length;e++){let t=a[e];for(let n=e+1;n<a.length;n++){let e=a[n],r=t.x-e.x,i=t.y-e.y,o=Math.hypot(r,i)||1;if(o<220){let n=s*s/o,a=r/o*n*.12,c=i/o*n*.12;t.x+=a,t.y+=c,e.x-=a,e.y-=c}}}t.forEach(e=>{let t=o[e.source],n=o[e.target];if(t&&n){let e=t.x-n.x,r=t.y-n.y,i=Math.hypot(e,r)||1,a=i*i/s,o=e/i*a*.08,c=r/i*a*.08;t.x-=o,t.y-=c,n.x+=o,n.y+=c}}),a.forEach(e=>{let t=n/2-e.x,i=r/2-e.y;e.x+=t*.015,e.y+=i*.015,e.x=Math.max(30,Math.min(n-30,e.x)),e.y=Math.max(30,Math.min(r-30,e.y))})}return a}function ju({memory:e,playClickSound:t,playHoverSound:n}){let[r,i]=(0,_.useState)(null),[a,o]=(0,_.useState)(``),[s,c]=(0,_.useState)(null),[l,u]=(0,_.useState)([]),[d,f]=(0,_.useState)(!1),[p,m]=(0,_.useState)(null),h=(0,_.useRef)(null),g=d?1200:850,v=d?650:500;(0,_.useEffect)(()=>{e&&e.nodes&&Object.keys(e.nodes).length>0?u(Au(e.nodes,e.edges,g,v)):u([])},[e,g,v]);let y=(0,_.useMemo)(()=>{let e={};return l.forEach(t=>{e[t.id]={x:t.x,y:t.y}}),e},[l]),b=(0,_.useMemo)(()=>{if(!p)return new Set;let t=new Set([p.id]);return e.edges.forEach(e=>{e.source===p.id&&t.add(e.target),e.target===p.id&&t.add(e.source)}),t},[p,e.edges]),x=(0,_.useMemo)(()=>{if(!a.trim())return l;let e=a.toLowerCase();return l.filter(t=>{let n=(t.properties?.name||t.id).toLowerCase(),r=t.label.toLowerCase();return n.includes(e)||r.includes(e)})},[l,a]),S=(0,_.useMemo)(()=>new Set(x.map(e=>e.id)),[x]),C=(0,_.useMemo)(()=>e.edges.filter(e=>y[e.source]&&y[e.target]),[e.edges,y]),w=(e,n)=>{t(),i(n),c(n)},T=e=>{if(!s||!h.current)return;let t=h.current.getBoundingClientRect(),n=g/t.width,r=v/t.height,a=(e.clientX-t.left)*n,o=(e.clientY-t.top)*r,c=Math.max(30,Math.min(g-30,a)),l=Math.max(30,Math.min(v-30,o));u(e=>e.map(e=>{if(e.id===s.id){let t={...e,x:c,y:l};return i(t),t}return e}))},E=()=>{c(null)};(0,_.useEffect)(()=>(s&&(window.addEventListener(`mousemove`,T),window.addEventListener(`mouseup`,E)),()=>{window.removeEventListener(`mousemove`,T),window.removeEventListener(`mouseup`,E)}),[s]);let D=e=>{switch(e){case`Candidate`:return`var(--gl-black)`;case`Interest`:return`#8B5CF6`;case`University`:return`#10B981`;case`Professor`:return`#F59E0B`;default:return`#6D6D6D`}},O=(0,_.useMemo)(()=>r?e.edges.filter(e=>e.source===r.id||e.target===r.id).map(t=>{let n=t.source===r.id?t.target:t.source,i=e.nodes[n];return{relation:t.relation,node:i,isSource:t.source===r.id}}):[],[r,e]);return(0,$.jsxs)(`div`,{className:`memory-dashboard-container animate-fade-in`,children:[(0,$.jsxs)(`div`,{className:`memory-controls-bar`,children:[(0,$.jsx)(`input`,{type:`text`,placeholder:`Filter nodes by name or entity type...`,className:`input-text graph-search-input`,value:a,onChange:e=>o(e.target.value)}),e.updated_at&&(0,$.jsxs)(`span`,{className:`memory-timestamp`,children:[`Last Sync: `,new Date(e.updated_at).toLocaleTimeString()]})]}),(0,$.jsxs)(`div`,{className:`memory-layout-grid ${d?`grid-expanded`:``}`,children:[(0,$.jsxs)(`div`,{className:`card graph-card`,style:{padding:`12px`,position:`relative`},children:[(0,$.jsx)(`div`,{style:{position:`absolute`,top:`16px`,right:`16px`,zIndex:10},children:(0,$.jsx)(`button`,{className:`btn btn-secondary`,style:{width:`auto`,padding:`6px 12px`,fontSize:`0.75rem`,textTransform:`none`,backgroundColor:`var(--gl-card-bg)`,backdropFilter:`blur(8px)`,display:`flex`,alignItems:`center`,gap:`6px`},onClick:()=>{t(),f(!d)},onPointerOver:n,children:d?`🗗 Collapse View`:`🗖 Expand View`})}),(0,$.jsxs)(`svg`,{ref:h,viewBox:`0 0 ${g} ${v}`,className:`graph-svg`,style:{width:`100%`,height:`auto`,display:`block`,maxHeight:d?`650px`:`500px`,transition:`max-height 0.3s ease`},children:[(0,$.jsx)(`defs`,{children:(0,$.jsx)(`marker`,{id:`arrow`,viewBox:`0 0 10 10`,refX:`24`,refY:`5`,markerWidth:`6`,markerHeight:`6`,orient:`auto-start-reverse`,children:(0,$.jsx)(`path`,{d:`M 0 0 L 10 5 L 0 10 z`,fill:`var(--gl-gray)`,opacity:`0.4`})})}),C.map((e,t)=>{let n=y[e.source],i=y[e.target];if(!n||!i)return null;let o=r&&(r.id===e.source||r.id===e.target),s=p!==null,c=p&&(p.id===e.source||p.id===e.target),l=a.trim().length>0,u=l?S.has(e.source)&&S.has(e.target):s?c:o,d=.25;return l?d=u?.95:.1:s?d=c?.95:.05:o&&(d=.95),(0,$.jsxs)(`g`,{children:[(0,$.jsx)(`line`,{x1:n.x,y1:n.y,x2:i.x,y2:i.y,className:u?`flow-line`:``,stroke:u?`var(--gl-black)`:`var(--gl-gray)`,strokeWidth:u?2.5:1.2,strokeOpacity:d,markerEnd:`url(#arrow)`,style:{transition:`stroke-opacity 0.2s ease, stroke-width 0.2s ease, stroke 0.2s ease`}}),o&&(0,$.jsx)(`text`,{x:(n.x+i.x)/2,y:(n.y+i.y)/2-5,fontSize:`9`,fill:`var(--gl-gray)`,textAnchor:`middle`,className:`edge-label`,style:{pointerEvents:`none`,userSelect:`none`,fontWeight:`bold`},children:e.relation})]},t)}),l.map(e=>{let t=r&&r.id===e.id,i=a.trim().length>0&&!S.has(e.id),o=p!==null,c=b.has(e.id),l=1;i?l=.15:o&&!c&&(l=.2);let u=D(e.label);return(0,$.jsxs)(`g`,{transform:`translate(${e.x}, ${e.y})`,style:{cursor:`pointer`,transition:s?.id===e.id?`none`:`transform 0.1s ease`},onMouseDown:t=>w(t,e),onPointerOver:()=>{n(),m(e)},onPointerOut:()=>m(null),children:[(t||p&&p.id===e.id)&&(0,$.jsxs)($.Fragment,{children:[(0,$.jsx)(`circle`,{r:`34`,fill:`none`,stroke:u,strokeWidth:`1.2`,strokeDasharray:`5,4`,className:`node-orbit`,style:{opacity:l*.7}}),(0,$.jsx)(`circle`,{r:`28`,fill:`none`,stroke:u,strokeWidth:`0.8`,strokeDasharray:`3,5`,className:`node-orbit-counter`,style:{opacity:l*.5}})]}),(0,$.jsx)(`polygon`,{points:t?`0,-22 22,0 0,22 -22,0`:`0,-16 16,0 0,16 -16,0`,fill:u,stroke:`var(--gl-light)`,strokeWidth:`3.2`,style:{opacity:l,filter:t?`drop-shadow(0px 4px 12px rgba(0,0,0,0.3))`:`drop-shadow(0px 2px 6px rgba(0,0,0,0.15))`,transition:`points 0.2s ease, opacity 0.2s ease, fill 0.2s ease`}}),(0,$.jsx)(`text`,{y:`28`,textAnchor:`middle`,fontSize:`10.5`,fontWeight:t?`bold`:`600`,fill:`var(--gl-black)`,style:{opacity:l,pointerEvents:`none`,userSelect:`none`,fontFamily:`var(--font-sans)`,transition:`opacity 0.2s ease`},children:e.properties?.name||e.id}),t&&(0,$.jsx)(`text`,{y:`-24`,textAnchor:`middle`,fontSize:`8.5`,fontWeight:`bold`,fill:u,style:{pointerEvents:`none`,textTransform:`uppercase`,letterSpacing:`0.05em`},children:e.label})]},e.id)})]}),(0,$.jsx)(`div`,{className:`graph-instructions`,children:(0,$.jsx)(`span`,{children:`💡 Click & drag nodes to organize. Hover to highlight connections. Select to inspect relations.`})})]}),(0,$.jsx)(`div`,{className:`card detail-inspector-card`,children:r?(0,$.jsxs)(`div`,{className:`animate-fade-in`,children:[(0,$.jsxs)(`span`,{className:`hero-label`,style:{color:D(r.label),fontWeight:`bold`},children:[r.label,` Entity`]}),(0,$.jsx)(`h3`,{className:`inspector-title`,children:r.properties?.name||r.id}),(0,$.jsx)(`div`,{className:`prof-divider`,style:{margin:`16px 0`}}),(0,$.jsxs)(`div`,{className:`inspector-properties`,children:[r.label===`Candidate`&&(0,$.jsxs)(`div`,{className:`prop-row`,children:[(0,$.jsx)(`span`,{className:`prop-key`,children:`Academic Stage`}),(0,$.jsx)(`span`,{className:`prop-value`,children:r.properties?.academic_level||`—`})]}),r.label===`Professor`&&(0,$.jsxs)($.Fragment,{children:[(0,$.jsxs)(`div`,{className:`prop-row`,children:[(0,$.jsx)(`span`,{className:`prop-key`,children:`Department`}),(0,$.jsx)(`span`,{className:`prop-value`,children:r.properties?.department||`—`})]}),(0,$.jsxs)(`div`,{className:`prop-row`,children:[(0,$.jsx)(`span`,{className:`prop-key`,children:`Citations`}),(0,$.jsx)(`span`,{className:`prop-value`,children:r.properties?.citations||`—`})]}),(0,$.jsxs)(`div`,{className:`prop-row`,children:[(0,$.jsx)(`span`,{className:`prop-key`,children:`H-Index`}),(0,$.jsx)(`span`,{className:`prop-value`,children:r.properties?.h_index||`—`})]})]}),r.label===`University`&&(0,$.jsxs)(`div`,{className:`prop-row`,children:[(0,$.jsx)(`span`,{className:`prop-key`,children:`University Name`}),(0,$.jsx)(`span`,{className:`prop-value`,children:r.properties?.name||`—`})]}),r.label===`Interest`&&(0,$.jsxs)(`div`,{className:`prop-row`,children:[(0,$.jsx)(`span`,{className:`prop-key`,children:`Research Field`}),(0,$.jsx)(`span`,{className:`prop-value`,children:r.properties?.name||`—`})]})]}),(0,$.jsx)(`h4`,{className:`relations-header`,children:`Active Memory Relations`}),O.length>0?(0,$.jsx)(`ul`,{className:`relations-list`,children:O.map((e,n)=>e.node?(0,$.jsxs)(`li`,{className:`relation-item`,children:[(0,$.jsx)(`span`,{className:`relation-badge`,style:{borderLeft:`3px solid ${D(e.node.label)}`},children:e.relation}),(0,$.jsxs)(`div`,{className:`relation-dest`,onClick:()=>{t();let n=l.find(t=>t.id===e.node.id);n&&i(n)},children:[(0,$.jsx)(`strong`,{children:e.node.properties?.name||e.node.id}),(0,$.jsxs)(`span`,{style:{fontSize:`0.75rem`,color:`var(--gl-gray)`,marginLeft:`6px`},children:[`(`,e.node.label,`)`]})]})]},n):null)}):(0,$.jsx)(`p`,{className:`tab-text-empty`,style:{fontSize:`0.8rem`},children:`No relationships mapped for this node.`})]}):(0,$.jsx)(`div`,{className:`inspector-placeholder`,children:(0,$.jsx)(`span`,{children:`🔎 Click any node in the Knowledge Graph to inspect properties and memory relations.`})})})]})]})}function Mu(){let[e,t]=(0,_.useState)(!1),[n,r]=(0,_.useState)(!0),[i,a]=(0,_.useState)(!1),[o,s]=(0,_.useState)(!1),[c,l]=(0,_.useState)(`cosmic`),[u,d]=(0,_.useState)(`directory`),[f,p]=(0,_.useState)({nodes:{},edges:[],updated_at:null}),[m,h]=(0,_.useState)(``),[g,v]=(0,_.useState)(null),[y,b]=(0,_.useState)([]),[x,S]=(0,_.useState)(null),[C,w]=(0,_.useState)(``),[T,E]=(0,_.useState)(``),[D,O]=(0,_.useState)([{text:`Subspace cosmic navigator ready.`,type:`greet`},{text:`Upload your academic resume to launch search...`,type:`gray`}]),k=(0,_.useRef)(null),A=(0,_.useRef)(null),[j,M]=(0,_.useState)(0),[N,ee]=(0,_.useState)(null),[te,P]=(0,_.useState)(null),[F,ne]=(0,_.useState)(``);(0,_.useEffect)(()=>{let e,t=()=>{M(e=>(e+.0018)%(Math.PI*2)),e=requestAnimationFrame(t)};return e=requestAnimationFrame(t),()=>cancelAnimationFrame(e)},[]),(0,_.useEffect)(()=>{e?document.body.classList.add(`dark-mode`):document.body.classList.remove(`dark-mode`)},[e]);let re=()=>{fetch(`http://localhost:8000/api/memory`).then(e=>{if(!e.ok)throw Error(`Memory API failed`);return e.json()}).then(e=>{p(e)}).catch(e=>{console.warn(`No memory graph fetched:`,e)})};(0,_.useEffect)(()=>{fetch(`http://localhost:8000/api/supervisors`).then(e=>e.json()).then(e=>{e.candidate&&e.candidate.name&&(v(e.candidate),b(e.matches||[]),ie(`Loaded cached supervisor matches from supervisor_matches.json`,`log`))}).catch(e=>{console.warn(`No supervisor matches fetched:`,e)}),re()},[]),(0,_.useEffect)(()=>{k.current&&k.current.scrollIntoView({behavior:`smooth`})},[D]),(0,_.useEffect)(()=>{if(!n)return;let e=A.current;if(!e)return;let t=e.getContext(`2d`),i=window.innerWidth,o=window.innerHeight;e.width=i,e.height=o;let s=[{x:0,y:-20},{x:-30,y:0},{x:30,y:0},{x:0,y:20},{x:-60,y:0},{x:60,y:0},{x:-30,y:-40},{x:30,y:-40},{x:0,y:-60},{x:0,y:60}].map(e=>{let t=Math.random()*Math.PI*2,n=Math.max(i,o)*(.6+Math.random()*.4);return{tx:i/2+e.x*2.5,ty:o/2+e.y*2.5,x:i/2+Math.cos(t)*n,y:o/2+Math.sin(t)*n,char:`◇◈◆♦`[Math.floor(Math.random()*4)],delay:Math.random()*20}}),c=0,l=()=>{t.clearRect(0,0,i,o),t.fillStyle=`#F2F2F2`,t.font=`700 12px 'JetBrains Mono', monospace`,t.textAlign=`center`,t.textBaseline=`middle`;let e=!0;if(s.forEach((n,r)=>{if(c>n.delay){let t=Math.min(1,(c-n.delay)/60),r=1-(1-t)**4;n.x+=(n.tx-n.x)*r,n.y+=(n.ty-n.y)*r,t<1&&(e=!1)}else e=!1;t.fillText(n.char,n.x,n.y)}),c>40){let e=Math.min(1,(c-40)/30);t.fillStyle=`rgba(242, 242, 242, ${e})`,t.font=`600 15px 'Space Grotesk', sans-serif`,t.fillText(`SUBSPACE`,i/2,o/2+190),t.font=`400 10px 'JetBrains Mono', monospace`,t.fillStyle=`rgba(109, 109, 109, ${e})`,t.fillText(`COSMIC PROFILE MAPPER`,i/2,o/2+215)}if(c++,e&&c>70){let e=0,n=()=>{t.clearRect(0,0,i,o);let c=1-e/30,l=4*c;t.font=`700 12px 'JetBrains Mono', monospace`,t.textAlign=`center`,t.textBaseline=`middle`,c>.05&&(t.fillStyle=`rgba(255, 0, 0, ${c*.8})`,s.forEach(e=>t.fillText(e.char,e.tx+l,e.ty)),t.fillStyle=`rgba(0, 0, 255, ${c*.8})`,s.forEach(e=>t.fillText(e.char,e.tx-l,e.ty))),t.fillStyle=`#F2F2F2`,s.forEach(e=>{let n=Math.random()<.15*(1-c)?`!<>-_/\\|:;=+*^?`[Math.floor(Math.random()*15)]:e.char;t.fillText(n,e.tx,e.ty)}),t.fillStyle=`rgba(242, 242, 242, 0.95)`,t.font=`600 15px 'Space Grotesk', sans-serif`,t.fillText(`SUBSPACE`,i/2,o/2+190),t.font=`400 10px 'JetBrains Mono', monospace`,t.fillStyle=`rgba(109, 109, 109, 0.95)`,t.fillText(`COSMIC PROFILE MAPPER`,i/2,o/2+215),e++,e<30?requestAnimationFrame(n):(a(!0),setTimeout(()=>{r(!1),ku()},800))};requestAnimationFrame(n)}else requestAnimationFrame(l)};requestAnimationFrame(l);let u=()=>{i=window.innerWidth,o=window.innerHeight,e.width=i,e.height=o};return window.addEventListener(`resize`,u),()=>window.removeEventListener(`resize`,u)},[n]);let ie=(e,t=`log`)=>{O(n=>[...n,{text:e,type:t}])},I=e=>{let t=e.target.files[0];if(!t)return;Ou(),h(t.name),ie(`Uploading file: ${t.name}...`,`cmd`);let n=new FormData;n.append(`file`,t),fetch(`http://localhost:8000/api/upload-resume`,{method:`POST`,body:n}).then(e=>{if(!e.ok)throw Error(`Upload failed`);return e.json()}).then(e=>{ie(`File successfully uploaded to: ${e.saved_path}`,`log`),ae(e.saved_path)}).catch(e=>{ie(`Upload error: ${e.message}`,`error`)})},ae=e=>{s(!0),O([]),ie(`Connecting to ws://localhost:8000/ws/run-search`,`h`);let t=new WebSocket(`ws://localhost:8000/ws/run-search`);t.onopen=()=>{ie(`WebSocket connection open. Sending start request for resume path: ${e}`,`log`),t.send(JSON.stringify({resume_filename:e}))},t.onmessage=e=>{let n=JSON.parse(e.data);n.type===`log`?ie(n.message,`log`):n.type===`status`?ie(`[Status] ${n.message}`,`h`):n.type===`complete`?(s(!1),v(n.data.candidate),b(n.data.matches),ie(`Pipeline complete! Map populated.`,`greet`),ku(),re(),t.close()):n.type===`error`&&(s(!1),ie(`[Pipeline Error] ${n.message}`,`error`),t.close())},t.onerror=e=>{s(!1),ie(`WebSocket connection error. Make sure FastAPI server is running on port 8000.`,`error`)},t.onclose=()=>{s(!1),ie(`WebSocket connection closed.`,`gray`)}},L=e=>{Ou(),S(e),E(e.match_analysis.email_subject),w(e.match_analysis.email_body)},oe=()=>{Ou(),S(null)},se=()=>{navigator.clipboard.writeText(C),ku(),alert(`Email body copied to clipboard!`)},ce=(e,t,n,r)=>{let i=0,a=1;if(e.label===`Interest`)i=160,a=1.25;else if(e.label===`University`)i=280,a=.75;else if(e.label===`Professor`)i=410,a=.4;else return{x:600,y:400};let o=t/(n||1)*Math.PI*2+r*a;return{x:600+Math.cos(o)*i,y:400+Math.sin(o)*i,radius:i}},{coordsMap:le,renderedNodes:ue}=(0,_.useMemo)(()=>{let e={};if(!f||!f.nodes)return{coordsMap:e,renderedNodes:[]};let t=null,n=[],r=[],i=[];Object.keys(f.nodes).forEach(e=>{let a=f.nodes[e];a.label===`Candidate`?t=e:a.label===`Interest`?n.push(a):a.label===`University`?r.push(a):a.label===`Professor`&&i.push(a)}),t&&(e[t]={x:600,y:400});let a=[];return n.forEach((e,t)=>{a.push({node:e,index:t,total:n.length})}),r.forEach((e,t)=>{a.push({node:e,index:t,total:r.length})}),i.forEach((e,t)=>{a.push({node:e,index:t,total:i.length})}),{coordsMap:e,renderedNodes:a.map(t=>{let n=ce(t.node,t.index,t.total,j);return e[t.node.id]=n,{...t.node,x:n.x,y:n.y,radius:n.radius}})}},[f,j]);(0,_.useMemo)(()=>{if(!te)return new Set;let e=new Set([te.id]);return f.edges.forEach(t=>{t.source===te.id&&e.add(t.target),t.target===te.id&&e.add(t.source)}),e},[te,f.edges]);let de=(0,_.useMemo)(()=>{if(!F.trim())return ue;let e=F.toLowerCase();return ue.filter(t=>{let n=(t.properties?.name||t.id).toLowerCase(),r=t.label.toLowerCase();return n.includes(e)||r.includes(e)})},[ue,F]);(0,_.useMemo)(()=>new Set(de.map(e=>e.id)),[de]),(0,_.useMemo)(()=>f.edges.filter(e=>le[e.source]&&le[e.target]),[f.edges,le]);let fe=e=>{switch(e){case`Candidate`:return`var(--gl-black)`;case`Interest`:return`#8B5CF6`;case`University`:return`#10B981`;case`Professor`:return`#F59E0B`;default:return`#6D6D6D`}},pe=(0,_.useMemo)(()=>N?f.edges.filter(e=>e.source===N.id||e.target===N.id).map(e=>{let t=e.source===N.id?e.target:e.source,n=f.nodes[t];return{relation:e.relation,node:n,isSource:e.source===N.id}}):[],[N,f]),me=(0,_.useMemo)(()=>!N||N.label!==`Professor`?null:y.find(e=>e.name.toLowerCase()===N.properties?.name?.toLowerCase()),[N,y]);return(0,$.jsxs)($.Fragment,{children:[n&&(0,$.jsxs)(`div`,{className:`gl-splash ${i?`slide-up`:``}`,children:[(0,$.jsx)(`canvas`,{ref:A,className:`gl-splash-canvas`}),(0,$.jsx)(`div`,{className:`gl-splash-fallback`,children:`SUBSPACE CONSOLE INITIALIZING...`})]}),(0,$.jsxs)(`div`,{id:`root`,children:[(0,$.jsxs)(`header`,{className:`app-header`,children:[(0,$.jsxs)(`div`,{className:`logo-container`,onClick:()=>{Ou()},children:[(0,$.jsx)(`span`,{className:`logo-dot`}),`SUBSPACE`,(0,$.jsx)(`span`,{className:`logo-subtitle`,children:`Cosmic Agent Navigator`})]}),(0,$.jsxs)(`ul`,{className:`nav-links`,children:[(0,$.jsx)(`li`,{children:(0,$.jsx)(`button`,{className:`nav-btn ${c===`cosmic`?`active`:``}`,onClick:()=>{Ou(),l(`cosmic`)},children:`🌌 Cosmic Map`})}),(0,$.jsx)(`li`,{children:(0,$.jsx)(`button`,{className:`nav-btn ${c===`flat`?`active`:``}`,onClick:()=>{Ou(),l(`flat`)},children:`📁 Directory List`})}),(0,$.jsx)(`li`,{children:(0,$.jsx)(`button`,{className:`theme-toggle`,onClick:()=>{Ou(),t(!e)},children:e?`☀️ LIGHT`:`🌙 DARK`})})]})]}),c===`cosmic`?(0,$.jsxs)(`div`,{className:`space-viewport`,children:[(0,$.jsxs)(`div`,{className:`hud-panel hud-panel-left`,children:[(0,$.jsx)(`h3`,{className:`hud-title`,children:`Intake & Controls`}),(0,$.jsxs)(`div`,{className:`form-group`,children:[(0,$.jsx)(`span`,{className:`form-label`,children:`Upload Portfolio / Resume`}),(0,$.jsxs)(`label`,{className:`file-uploader`,style:{padding:`20px 10px`},children:[(0,$.jsx)(`input`,{type:`file`,accept:`.pdf,.txt,.md`,onChange:I,style:{display:`none`}}),(0,$.jsx)(`div`,{className:`file-uploader-icon`,style:{fontSize:`1.4rem`,marginBottom:`4px`},children:`📂`}),(0,$.jsx)(`div`,{className:`file-uploader-text`,style:{fontSize:`0.8rem`},children:m||`PDF / TXT / MD File`})]})]}),g&&(0,$.jsxs)(`div`,{style:{animation:`fadeIn 0.4s ease-out`},children:[(0,$.jsxs)(`span`,{className:`form-label`,children:[`Navigator: `,g.name]}),(0,$.jsx)(`div`,{className:`profile-pill-container`,style:{maxHeight:`80px`,overflowY:`auto`},children:g.research_interests.map((e,t)=>(0,$.jsx)(`span`,{className:`profile-pill`,style:{fontSize:`0.7rem`,padding:`2px 8px`},children:e},t))})]}),(0,$.jsxs)(`div`,{style:{display:`flex`,flexDirection:`column`,flex:1,minHeight:0},children:[(0,$.jsx)(`span`,{className:`form-label`,children:`Subspace Log Stream`}),(0,$.jsxs)(`div`,{style:{flex:1,backgroundColor:`#090d16`,borderRadius:`8px`,padding:`12px`,overflowY:`auto`,fontFamily:`var(--font-mono)`,fontSize:`0.7rem`,lineHeight:`1.4`,color:`#c5c9db`},children:[D.map((e,t)=>(0,$.jsx)(`div`,{className:`console-line console-${e.type}`,style:{marginBottom:`4px`},children:e.text},t)),(0,$.jsx)(`div`,{ref:k})]})]})]}),(0,$.jsx)(Su,{memory:f,supervisors:y,selectedNode:N,setSelectedNode:ee,hoveredNode:te,setHoveredNode:P,searchQuery:F,getNodeColor:fe,playClickSound:Ou,playHoverSound:Du,darkMode:e}),(0,$.jsx)(`div`,{className:`hud-panel hud-panel-right`,children:(0,$.jsx)(`div`,{className:`hud-scrollable-content`,children:N?(0,$.jsxs)(`div`,{className:`animate-fade-in`,children:[(0,$.jsxs)(`span`,{className:`hero-label`,style:{color:fe(N.label),fontWeight:`bold`},children:[N.label,` Coordinate`]}),(0,$.jsx)(`h3`,{className:`inspector-title`,style:{fontSize:`1.4rem`,marginTop:`6px`},children:N.properties?.name||N.id}),(0,$.jsx)(`div`,{className:`prof-divider`,style:{margin:`14px 0`}}),(0,$.jsxs)(`div`,{className:`inspector-properties`,children:[N.label===`Candidate`&&(0,$.jsxs)(`div`,{className:`prop-row`,children:[(0,$.jsx)(`span`,{className:`prop-key`,children:`Academic Stage`}),(0,$.jsx)(`span`,{className:`prop-value`,children:N.properties?.academic_level||`—`})]}),N.label===`Professor`&&(0,$.jsxs)($.Fragment,{children:[(0,$.jsxs)(`div`,{className:`prop-row`,children:[(0,$.jsx)(`span`,{className:`prop-key`,children:`Department`}),(0,$.jsx)(`span`,{className:`prop-value`,children:N.properties?.department||`—`})]}),(0,$.jsxs)(`div`,{className:`prop-row`,children:[(0,$.jsx)(`span`,{className:`prop-key`,children:`Citations`}),(0,$.jsx)(`span`,{className:`prop-value`,children:N.properties?.citations||`—`})]}),(0,$.jsxs)(`div`,{className:`prop-row`,children:[(0,$.jsx)(`span`,{className:`prop-key`,children:`H-Index`}),(0,$.jsx)(`span`,{className:`prop-value`,children:N.properties?.h_index||`—`})]}),me&&(0,$.jsxs)(`div`,{className:`prop-row`,children:[(0,$.jsx)(`span`,{className:`prop-key`,style:{color:`var(--gl-black)`},children:`Match Score`}),(0,$.jsxs)(`span`,{className:`prop-value`,style:{color:`#F59E0B`,fontWeight:800},children:[me.match_analysis?.score||0,`%`]})]})]}),N.label===`University`&&(0,$.jsxs)(`div`,{className:`prop-row`,children:[(0,$.jsx)(`span`,{className:`prop-key`,children:`Institution`}),(0,$.jsx)(`span`,{className:`prop-value`,children:N.properties?.name||`—`})]}),N.label===`Interest`&&(0,$.jsxs)(`div`,{className:`prop-row`,children:[(0,$.jsx)(`span`,{className:`prop-key`,children:`Research Subfield`}),(0,$.jsx)(`span`,{className:`prop-value`,children:N.properties?.name||`—`})]})]}),N.label===`Professor`&&me&&(0,$.jsxs)(`div`,{style:{marginTop:`16px`,animation:`fadeIn 0.3s ease-out`},children:[(0,$.jsx)(`span`,{className:`form-label`,children:`Stellar Overlap`}),(0,$.jsx)(`p`,{style:{fontSize:`0.8rem`,color:`var(--gl-gray)`,lineHeight:`1.4`,marginBottom:`12px`},children:me.match_analysis?.research_overlap}),(0,$.jsx)(`span`,{className:`form-label`,children:`Research Direction`}),(0,$.jsx)(`p`,{style:{fontSize:`0.8rem`,color:`var(--gl-gray)`,fontStyle:`italic`,lineHeight:`1.4`,marginBottom:`16px`},children:me.match_analysis?.custom_research_direction}),(0,$.jsx)(`button`,{className:`btn`,style:{padding:`10px 16px`,fontSize:`0.8rem`},onClick:()=>L(me),children:`Draft Outreach Proposal`})]}),(0,$.jsx)(`h4`,{className:`relations-header`,children:`Gravity Relations`}),pe.length>0?(0,$.jsx)(`ul`,{className:`relations-list`,children:pe.map((e,t)=>e.node?(0,$.jsxs)(`li`,{className:`relation-item`,children:[(0,$.jsx)(`span`,{className:`relation-badge`,style:{borderLeft:`3px solid ${fe(e.node.label)}`,minWidth:`90px`},children:e.relation}),(0,$.jsxs)(`div`,{className:`relation-dest`,onClick:()=>{Ou();let t=f.nodes[e.node.id];t&&ee(t)},children:[(0,$.jsx)(`strong`,{children:e.node.properties?.name||e.node.id}),(0,$.jsxs)(`span`,{style:{fontSize:`0.7rem`,color:`var(--gl-gray)`,marginLeft:`4px`},children:[`(`,e.node.label,`)`]})]})]},t):null)}):(0,$.jsx)(`p`,{className:`tab-text-empty`,style:{fontSize:`0.8rem`},children:`No celestial connections mapped.`})]}):(0,$.jsx)(`div`,{className:`inspector-placeholder`,style:{padding:`30px 10px`},children:(0,$.jsx)(`span`,{children:`🔎 Select any planetary coordinate orbiting in the Subspace chart to inspect details.`})})})})]}):(0,$.jsxs)(`main`,{className:`main-content`,children:[(0,$.jsxs)(`section`,{className:`hero-section`,children:[(0,$.jsx)(`span`,{className:`hero-label`,children:`Autonomous Academic Agent`}),(0,$.jsxs)(`h1`,{className:`hero-title`,children:[`Find Your `,(0,$.jsx)(`em`,{children:`Research Supervisor`})]}),(0,$.jsx)(`p`,{className:`hero-description`,children:`Upload your academic resume, portfolio, or statement of purpose. Subspace will autonomously parse your profile, conduct a global web search using Google grounding, fetch publication indexes from OpenAlex, evaluate compatibility, and write tailored cold email drafts.`})]}),(0,$.jsxs)(`div`,{className:`dashboard-grid`,children:[(0,$.jsxs)(`div`,{style:{display:`flex`,flexDirection:`column`,gap:`24px`},children:[(0,$.jsxs)(`div`,{className:`card`,children:[(0,$.jsx)(`h3`,{className:`card-title`,children:`Intake & Controls`}),(0,$.jsxs)(`div`,{className:`form-group`,children:[(0,$.jsx)(`span`,{className:`form-label`,children:`Step 1: Upload Portfolio / Resume`}),(0,$.jsxs)(`label`,{className:`file-uploader`,children:[(0,$.jsx)(`input`,{type:`file`,accept:`.pdf,.txt,.md`,onChange:I,style:{display:`none`}}),(0,$.jsx)(`div`,{className:`file-uploader-icon`,children:`📂`}),(0,$.jsx)(`div`,{className:`file-uploader-text`,children:m||`Drag & drop PDF/TXT or Click to browse`})]})]}),g&&(0,$.jsxs)(`div`,{style:{marginTop:`24px`,animation:`fadeIn 0.4s ease-out`},children:[(0,$.jsx)(`span`,{className:`form-label`,children:`Parsed Academic Profile`}),(0,$.jsx)(`p`,{style:{fontWeight:700,fontSize:`1.1rem`},children:g.name}),(0,$.jsxs)(`p`,{style:{color:`var(--gl-gray)`,fontSize:`0.85rem`},children:[`Stage: `,g.academic_level]}),(0,$.jsx)(`span`,{className:`form-label`,style:{marginTop:`16px`},children:`Research Domains`}),(0,$.jsx)(`div`,{className:`profile-pill-container`,children:g.research_interests.map((e,t)=>(0,$.jsx)(`span`,{className:`profile-pill`,children:e},t))})]}),m&&(0,$.jsx)(`button`,{className:`btn`,style:{marginTop:`24px`},onClick:()=>ae(m),disabled:o,children:o?`Searching...`:`Re-Run Search Pipeline`})]}),(0,$.jsxs)(`div`,{className:`card`,style:{padding:`24px`,display:`flex`,flexDirection:`column`,height:`380px`},children:[(0,$.jsxs)(`div`,{style:{display:`flex`,justifyContent:`space-between`,alignItems:`center`,marginBottom:`14px`},children:[(0,$.jsxs)(`h4`,{style:{margin:0,fontSize:`0.78rem`,textTransform:`uppercase`,letterSpacing:`0.08em`,display:`flex`,alignItems:`center`,gap:`8px`},children:[(0,$.jsx)(`span`,{className:`console-pulse-dot ${o?`running`:``}`}),`Agent Logs Terminal`]}),(0,$.jsx)(`button`,{onClick:()=>{Ou(),O([{text:`Console cleared.`,type:`gray`}])},className:`btn btn-secondary`,style:{width:`auto`,padding:`4px 8px`,fontSize:`0.7rem`,textTransform:`none`},children:`Clear`})]}),(0,$.jsxs)(`div`,{style:{flex:1,backgroundColor:`#090d16`,borderRadius:`8px`,padding:`14px`,overflowY:`auto`,fontFamily:`var(--font-mono)`,fontSize:`0.74rem`,lineHeight:`1.45`,color:`#c5c9db`},children:[D.map((e,t)=>(0,$.jsx)(`div`,{className:`console-line console-${e.type}`,style:{marginBottom:`5px`,wordBreak:`break-word`,whiteSpace:`pre-wrap`},children:e.text},t)),(0,$.jsx)(`div`,{ref:k})]})]})]}),(0,$.jsx)(`div`,{style:{display:`flex`,flexDirection:`column`,gap:`24px`,flex:1,minWidth:0},children:(0,$.jsx)(wu,{supervisors:y,openEmailModal:L,playClickSound:Ou,playHoverSound:Du,darkMode:e,activeMainTab:u,setActiveMainTab:d,children:(0,$.jsx)(ju,{memory:f,playClickSound:Ou,playHoverSound:Du})})})]})]}),x&&(0,$.jsx)(`div`,{className:`email-modal animate-fade-in`,children:(0,$.jsxs)(`div`,{className:`email-modal-content`,children:[(0,$.jsxs)(`div`,{className:`email-modal-header`,children:[(0,$.jsx)(`span`,{className:`hero-label`,children:`Custom Outreach Writer`}),(0,$.jsx)(`button`,{className:`email-close`,onClick:oe,children:`×`})]}),(0,$.jsxs)(`div`,{children:[(0,$.jsxs)(`h3`,{className:`prof-name`,children:[`Cold Outreach to `,x.name]}),(0,$.jsx)(`span`,{className:`prof-uni`,children:x.university})]}),(0,$.jsxs)(`div`,{className:`email-meta-input`,children:[(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`strong`,{children:`To:`}),` `,x.email||`No email parsed (Use website contact page)`]}),(0,$.jsxs)(`div`,{style:{marginTop:`8px`,display:`flex`,gap:`8px`,alignItems:`center`},children:[(0,$.jsx)(`strong`,{children:`Subject:`}),(0,$.jsx)(`input`,{type:`text`,className:`input-text`,style:{padding:`6px 12px`,fontSize:`0.85rem`},value:T,onChange:e=>E(e.target.value)})]})]}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`span`,{className:`form-label`,children:`Email Body`}),(0,$.jsx)(`textarea`,{className:`email-body-editor`,value:C,onChange:e=>w(e.target.value)})]}),(0,$.jsxs)(`div`,{className:`email-actions`,children:[(0,$.jsx)(`button`,{className:`btn btn-secondary`,onClick:se,onPointerOver:Du,children:`Copy Content`}),(0,$.jsx)(`a`,{href:`mailto:${x.email||``}?subject=${encodeURIComponent(T)}&body=${encodeURIComponent(C)}`,className:`btn`,style:{textDecoration:`none`},onPointerOver:Du,onClick:()=>{Ou(),oe()},children:`Send via Mail Client`})]})]})})]})]})}(0,v.createRoot)(document.getElementById(`root`)).render((0,$.jsx)(_.StrictMode,{children:(0,$.jsx)(Mu,{})}));